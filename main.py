    ...
    try:
        ...
        with tab2:
            ...
            if current_cols:
                ...
                y_target, meth = c2.selectbox("🎯 对象(Y)", current_cols, key="y_sel"), c3.selectbox("🧮 方法", ["计数","唯一值计数", "求和", "平均值", "中位数","最大值","最小值"], key="meth_sel")
                ...
                if g_by_cols:
                    m_map = {"计数": "count","唯一值计数": "nunique", "求和": "sum", "平均值": "mean", "最小值": "min", "最大值": "max", "中位数": "median"}
